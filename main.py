...
async def stock(ctx):
    if ctx.channel.id == free_gen_channel_id:
        ...
        embed = discord.Embed(
            title="Hxpnotic Gen Stock",
            description=(
                stock1
            ),
            color=discord.Color.from_rgb(250, 10, 214)
        )
        embed.set_footer(text="Hecho por hxpnotic")
